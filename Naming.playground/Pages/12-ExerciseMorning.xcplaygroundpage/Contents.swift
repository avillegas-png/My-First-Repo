...
let totalTime = floss + brushTeeth + chooseClothes + checkEmails + checkSocials + shower + eatBreakfast
...
let haveToDo = shower + floss + brushTeeth + chooseClothes
let likeToDo = checkSocials + checkEmails + eatBreakfast
/*:
